...
def sensorsReceivedEventHandler(sender, dataCurrent):
    ...
    #print(sender.name + ": Location [" + dataCurrent.Location.Values.AsString + "]")
    #print(sender.name + ": Location Speed [" + dataCurrent.Location.Values.AsString + "]")
    my_location_data = (dataCurrent.Location.Values.AsString).split()
